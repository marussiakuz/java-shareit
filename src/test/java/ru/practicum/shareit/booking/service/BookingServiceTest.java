...
class BookingServiceTest {
    ...
    void whenTryToBookNotAvailableItemThenInvalidRequestException() {
        ...
        Assertions.assertEquals("booking attempt failed due to incorrect data", exception.getMessage());
    ...
    @Test
    void whenTryToAddBookingStartIsBeforeNowThenInvalidRequestException() {
        BookingInDto bookingInDto = BookingInDto.builder()
    ...
    @Test
    void whenTryToAddBookingStartIsAfterEndNowThenInvalidRequestException() {
        BookingInDto bookingInDto = BookingInDto.builder()
    ...
    @Test
    void whenTryToGetUserBookingsIfStateIsNotValidThenInvalidRequestException() {
        final InvalidRequestException exception = Assertions.assertThrows(
                InvalidRequestException.class,
    ...
    @Test
    void whenTryToGetBookingsByOwnerIdIfStateIsNotValidThenInvalidRequestException() {
        final InvalidRequestException exception = Assertions.assertThrows(
                InvalidRequestException.class,
